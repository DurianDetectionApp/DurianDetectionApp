...
If the API is unavailable, the app automatically falls back to mock mode so the user experience is not interrupted.
...
- `App.tsx`: App entry point, font loading, and initial setup.
- `src/navigation`: Navigation configuration between app screens.
- `src/screens`: Main app screens.
- `src/components`: Shared UI components.
- `src/services`: Audio and AI logic.
- `src/store`: Zustand stores for auth, history, record, and settings.
- `src/theme`: Colors, typography, and UI helpers.
