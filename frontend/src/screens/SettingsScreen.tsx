  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      >
          ...
          <View style={styles.profileTop}>
            ...
            <View style={styles.profileInfo}>
              <Text style={styles.profileName}>
                {user?.username || "Durian Lover"}
              </Text>
              <Text style={styles.profileEmail}>
                {user?.email || "user@durly.ai"}
              </Text>
            </View>
        ...
        <SettingsCard
          colors={colors}
          icon={<Palette size={18} color={colors.primaryDark} />}
        ...
        >
          <View style={styles.themeRow}>
            ...
            >
              <Sun
                size={18}
                color={theme === "light" ? colors.white : colors.textMuted}
              />
              <Text
                style={[
                  styles.themeBtnText,
            ...
            >
              <Moon
                size={18}
                color={theme === "dark" ? colors.white : colors.textMuted}
              />
              <Text
                style={[
                  styles.themeBtnText,
        ...
        <View style={styles.footerInfo}>
          ...
          <Text style={styles.footerCopyright}>© 2026 Durly</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
