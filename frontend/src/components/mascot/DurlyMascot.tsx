...
const STATE_IMAGES = {
  idle: require("../../../assets/images/durly_idle.jpg"),
  recording: require("../../../assets/images/durly_recording.jpg"),
  processing: require("../../../assets/images/durly_processing.jpg"),
  done: require("../../../assets/images/durly_done.jpg"),
  error: require("../../../assets/images/durly_error.jpg"),
};
